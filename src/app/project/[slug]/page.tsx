            ...
            <ParallaxProvider>
                ...
                <section className=" relative flex items-center justify-center overflow-hidden h-screen-75 md:h-screen">
                    <Parallax
                        scale={[1, 2]}
                    >
                        <div className={`relative flex items-center w-screen justify-center overflow-hidden h-screen-75 md:h-screen`}>
                ...
                <section className=" relative flex flex-col items-center justify-center overflow-hidden bg-main mt-40">
                    <div className="flex flex-col justify-center items-center relative h-full w-full z-30 py-20 md:py-32 bg-opacity-50">
                        <div className={`grid md:grid-cols-3 gap-4 md:w-10/12`}>
                            <div className={`shadow-xl p-5 bg-main-alt text-white transform transition cursor-pointer delay-100 duration-1000 ease-in-out hover:scale-105 hover:bg-main-alt2`}>
                                <div className={montserrat_bold.className}>
                                    <p className={`text-2xl font-bold capitalize text-gray-400`}>Location</p>
                                </div>
                                <div className={montserrat.className}>
                            ...
                            <div className={`shadow-xl p-5 bg-main-alt text-white transform transition cursor-pointer delay-100 duration-1000 ease-in-out hover:scale-105 hover:bg-main-alt2`}>
                                <div className={montserrat_bold.className}>
                                    <p className={`text-2xl font-bold capitalize text-gray-400`}>Delivery</p>
                                </div>
                                <div className={montserrat.className}>
                            ...
                            <div className={`shadow-xl p-5 bg-main-alt text-white transform transition cursor-pointer delay-100 duration-1000 ease-in-out hover:scale-105 hover:bg-main-alt2`}>
                                <div className={montserrat_bold.className}>
                                    <p className={`text-2xl font-bold capitalize text-gray-400`}>Number of housing</p>
                                </div>
                                <div className={montserrat.className}>
                                    <p className={`text-3xl pb-5`}>
                                        {project.propertyNumber}</p>
                                </div>
                            </div>
                            <div className={`shadow-xl p-5 bg-main-alt text-white transform transition cursor-pointer delay-100 duration-1000 ease-in-out hover:scale-105 hover:bg-main-alt2`}>
                                <div className={montserrat_bold.className}>
                                    <p className={`text-2xl font-bold capitalize text-gray-400`}>House types</p>
                                </div>
                                <div className={montserrat.className}>
                                    <p className={`text-3xl pb-5`}>
                        ...
                        <div className="flex flex-col px-3 md:w-10/12 md:flex-row h-full gap-20 items-center text-white mt-20 z-20 relative">
                            <div className="md:w-6/12  h-full flex flex-col justify-between">
                                <Parallax speed={10}>
                                    <div className="flex flex-col items-start" >
                                        <div className={comorant_garamond.className}>
                                            <h1 className="text-5xl md:text-7xl mb-4">The Project<br/>in Details</h1>
                                        </div>
                                        <div className={montserrat.className}>
                                        ...
                                        <Link href={''}>
                                            <div className={`items-center border-l-2 border-white flex mt-10 backdrop-blur-sm bg-white/30`}>
                                                <div className={montserrat.className}>
                                                    <p className={`text-lg px-5 pr-40 text-white`}>Download Brochure</p>
                                                </div>
                                                <div className={`bg-white text-black flex justify-center items-center p-5`}>
                                                    <div className={`transform hover:translate-x-3 transition duration-500 ease-in-out`}>
                                                        <BsArrowRight className={` h-6 w-6 `}/>
                                        ...
                                        <div className="relative h-125 w-full z-30 p-5 text-white main-gradient-alternate bg-opacity-50">
                                            <div className={`h-125 flex flex-col justify-end -mt-10`}>
                                                <div className={montserrat.className}>
                                                    ...
                                                    <div className={comorant_garamond.className}>
                                                        <h1 className="text-xl md:text-5xl py-3">{item.name}</h1>
                                                    </div>
                                                    <p className={``}>{truncateText(item.description, 50)}</p>
