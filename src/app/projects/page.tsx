                ...
                <div className="flex flex-col items-start">
                  ...
                  <div className={montserrat.className}>
                    <div className={`pt-5 lg:w-10/12`}>
                      We invest across Nigeria, focusing on Locations where our
                      team has experience and where there is scope to aggregate
                      assets in our target sectors. Wherever we invest, we
                      partner with highly skilled management teams to build
