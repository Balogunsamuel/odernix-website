                    ...
                    <div className="flex flex-row h-full container z-20 mx-auto relative">
                            ...
                            <div className="flex flex-col pt-16 items-start" >
                                <div className={comorant_garamond.className}>
                                    <h1 className="home_main_text">
                                        Awe-Inspiring<br/>Buildings to<br/>Choose from
                                    </h1>
                                </div>

                                <Link href={''}>
                                    <div className={`items-center border-l-2 border-white flex mt-10 flex backdrop-blur-sm bg-white/30`}>
                                        <div className={montserrat.className}>
                                            <p className={`text-lg px-5 pr-40 text-white`}>Get started</p>
                                        </div>
                        ...
                        <div className=" h-full flex justify-end hidden md:flex">
                            <div className={"absolute right-0 bottom-60"}>
                                <div className={montserrat.className}>
                                    <div className={`items-center border-l-2 border-white flex  w-80 flex backdrop-blur-sm bg-white/30`}>
                                        <p className={`text-lg p-5 text-white`}>Travelers today seek more than just a place to stay – they crave an experience that is beyond the ordinary.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
